...
The product uses a simple and intuitive interface divided in for containers:
...
- ✅ Builder, Right Panel shows the properties for acrive components and Page Globals
